...
const TravelAgentHome = () => {
  ...
  return (
    <Container className="mt-5">
        <h1 style={{textAlign: "center", padding: "25px"}}>Travel Agent Home Page</h1>
      <Row className="mb-4">
        <Col md={6}>
          <Card style={{textAlign: "center", padding: "25px"}}>
            <Card.Img variant="top" src="https://img.freepik.com/premium-vector/subway-underground-train-car-modern-interior-with-various-passengers-with-gadgets-vector_985641-897.jpg" style={{height: "250px"}} />
            <Card.Body>
              <Card.Title>Reservation List</Card.Title>
              <Card.Text>
                Manage your reservations, view reservations, and update existing reservation.
              </Card.Text>
              <Button variant="primary" href='/reservationlist'>Reservation List</Button>
            </Card.Body>
          </Card>
        </Col>
        <Col md={6}>
          <Card style={{textAlign: "center", padding: "25px"}}>
            <Card.Img variant="top" src="https://t4.ftcdn.net/jpg/02/79/99/49/360_F_279994994_hML4lWFVXnSGXdvSvg1ehASiGKHZKtRr.jpg" style={{height: "250px"}} />
            <Card.Body>
              <Card.Title>Travel User List</Card.Title>
              <Card.Text>
              View and manage reservations, update passenger details, and more.
              </Card.Text>
              <Button variant="primary" href='/travellerlist'>Go to Travel User List</Button>
            </Card.Body>
          </Card>
        </Col>
      </Row>
